...
const gameConfig = {
  mlbb: {
    ...
    image: 'https://www.daddytopup.com/_next/image?url=https%3A%2F%2Fdaddy-cms.minttopup.xyz%2FUploads%2FImg_Resizer_20240801_2222_57312_4914487dd4.webp&w=1080&q=75',
      ...
      <div className="feature-grid grid grid-cols-2 gap-4">
        {[
          ...
          },
          {
            ...
            desc: 'ជំនួយការអតိថិជនដែលទាក់ទងរបស់ពួកយើងតែងតែមាន ដើម្បីអ្នកគ្រប់ពេលវេលា។',
          },
        ].map((item, index) => (
          <div
            key={index}
    ...
    <div className="grid grid-cols-1 gap-8 text-center">
      ...
      <div>
        ...
        <ul className="flex justify-center space-x-4">
          ...
          <li>
            <a href="https://t.me/netonlinegaming777" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Telegram">
