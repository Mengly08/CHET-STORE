  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const gameDisplayName = {
        'mlbb': 'Mobile Legends',
        'freefire': 'Free Fire',
        'magicchessgogo': 'Magic Chess GoGo'
      }[orderData.game] || orderData.game;
        ...
        {orderDetails && (
          <div className="mt-4 p-4 bg-green-50 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p><span className="font-medium">ID User:</span> {orderDetails.idUser}</p>
              <p><span className="font-medium">Zone ID:</span> {orderDetails.zoneId}</p>
